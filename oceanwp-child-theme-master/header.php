...
<div class="popup-overlay">
	<div class="popup-salon">
		...
		echo do_shortcode('[contact-form-7 id="caa9f36" title="Formulaire salon New York"]');
		?>
	</div>
</div>

<!-- Code pour fermer la popup -->
<!-- script corrigé déplacé dans scripts/script.js et enqueue dans functions  -->

<!-- Ajout d'un bouton contact au menu  -->
<!-- déjà présent dans functions.php  -->
